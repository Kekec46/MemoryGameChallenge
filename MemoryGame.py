...
label_name = Label ( app , anchor = CENTER , text = "Mehmet KEKEC " , font = ( "arial" , 10 , "italic bold" ) , bg = 'SeaGreen2' , fg = 'steelblue' )
